...
def GenerateCAH(filename, outfile="NULL", separator=";", XSize=10, YSize=9, dpi=300):
    ...
    #plt.show()
    plt.savefig('CAH-MaxClust-Elbow-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    plt.savefig('CAH-MaxClust-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    ## Print in a file
    print("## Clusters CSV")
    CSV_OUT_filename = 'Clusters-CAH-MaxClust-' + outfile + '.csv'
