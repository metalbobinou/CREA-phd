...
def GenerateCAH(filename, outfile="NULL", separator=";", XSize=10, YSize=9, dpi=300):
    ...
    ## PARAMETRE DISTANCE POUR CLUSTERING CAH :
    max_distance = 14

    ## PHP-3-next :
    ## Directe : 48 (52 ?)    S=M : 39
    ## S=B : 14    S=H : 12
    
    ## PHP-no-java-no-code :
    ## Directe : 38 (40 ?)    S=M : 40
    ## S=B : 20    S=H : 15

    ## PHP-no-java :
    ## Directe : 50 (80 ?)    S=M : 42 (50 ?)
    ## S=B : 15 (20 ?)    S=H : 15
    
    ## Dissimilarity Simple :
    ## Directe : 43 (76 ?)    S=M : 46 (78 ? 80 ?)
    ## S=B : 19    S=H : 25 (17 ?)

    ## Dissimilarity Complex:
    ## Directe : 50 (50 ? 60 ? 74 ? 87 ? 95 ?)    S=M : 75 (100 ?)
    ## S=B : 22 (21 ?)    S=H : 21 (16 ? 21 ? 23 ?)

    ## Similarity :
    ## Directe : 38 ou 40 ou 78     S=M : 44 ou 45 ou 42 ou 38 ou 110
    ## S=B : 16 ou 19 ou 15    S=H : 25 ou 17 ou 21 ou 15

    print("")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("!!! PARAMETRE : MAX_DISTANCE = " + str(max_distance) + " !!!!!!")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("")

    ## Choix de la taille à indiquer sur le graphique
    threshold_height = max_distance
    ...
    ## 3.1) "Elbow Method"
    ##  (Elbow va avec fcluster + criterion="maxclust")
    ## On prend la plus forte acceleration (dérivée de la droite)
    ...
    #plt.show()
    plt.savefig('CAH-Distance-Elbow-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    ##plt.figure(dpi=200)
    plt.title("CAH fcluster 'distance' (max_distance ["
              + str(max_distance)
              + "] decoupage à "
    ...
    plt.savefig('CAH-Distance-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    ## Print in a file
    print("## Clusters CSV")
    CSV_OUT_filename = 'Clusters-CAH-Distance' + outfile + '.csv'
