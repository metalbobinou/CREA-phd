...
def GenerateMDS(filename, outfile="NULL", separator=";",
    ...
    #plt.show()
    plt.savefig('Barycentres-MDS+K-Means-8-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    CSV_OUT_filename = 'Clusters-MDS+K-Means-8-' + outfile + '.csv'
...
'whitesmoke':           '#F5F5F5', 'yellow':               '#FFFF00',
    ...
    #plt.show()
    plt.savefig('Clusters-MDS+K-Means-8-' + outfile + '.png', format='png', bbox_inches='tight')
    #plt.savefig(outfile + '.jpg', format='jpg', bbox_inches='tight') # JPG
    ...
    #plt.show()
    plt.savefig('Liens-Amis-MDS+K-Means-8-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    #plt.savefig(outfile + '.jpg', format='jpg', bbox_inches='tight') # JPG
