...
def GenerateDBSCAN(filename, outfile="NULL", separator=";", XSize=10, YSize=9, dpi=300):
    ...
    param_eps = 1.12   # Max curvature of NearestNieghbors
    param_min_samples = 4 # Best to use is 4
    ...
    db = DBSCAN(eps=param_eps, min_samples=param_min_samples)
