...
def GenerateCAH(filename, outfile="NULL", separator=";", XSize=10, YSize=9, dpi=300):
    ...
    ## PARAMETRES DISTANCE POUR CLUSTERING CAH :
    param_threshold = 0.8
    param_depth = 2
    # DEPTH DEFAULT = 2 (in fcluster)
    ...
    ## Similarity :
    ## Directe :      S=M :
    ## S=B :    S=H : t=0.8 d=2 ou d=5 ????

    print("")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("!!! PARAMETRE : THRESHOLD = " + str(param_threshold) + " !!!!!!")
    print("!!! PARAMETRE : DEPTH = " + str(param_depth) + "  !!!!!!")
    print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!")
    print("")
    ...
    #plt.show()
    plt.savefig('CAH-Elbow-' + outfile + '.png', format='png', bbox_inches='tight') # PNG
    ...
    incons_threshold = param_threshold
    ...
    ##plt.figure(dpi=200)
    plt.title("CAH fcluster 'inconsistent' (inconsistent threshold ["
              + str(param_threshold)
              + "] depth ["
              + str(param_depth)
              + "] decoupage à "
    ...
    #groupes_cah = fcluster(data_LinkMatrix, t=threshold, depth=depth, criterion='inconsistent')

    groupes_cah = fcluster(data_LinkMatrix, t=incons_threshold, depth=depth, criterion='inconsistent')
    print(groupes_cah)
    print("\n")
